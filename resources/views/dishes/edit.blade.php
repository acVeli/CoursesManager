                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <button type="button" onclick="addIngredient()" class="inline-flex items-center px-3 py-1.5 bg-indigo-600 text-black rounded-md text-xs font-semibold hover:bg-indigo-500">Ajouter un ingrédient</button>
                            </div>
                        ...
                        <div class="flex justify-end gap-2">
                            <a href="{{ route('dishes.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-black rounded-md text-xs font-semibold hover:bg-gray-500">Annuler</a>
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-green-600 text-black rounded-md text-xs font-semibold hover:bg-green-500">Enregistrer</button>
                        </div>
                    </div>
                </form>
            </div>
