                ...
                <form method="POST" action="{{ route('dishes.store') }}" id="dish-form">
                    ...
                    <div class="border border-gray-200 dark:border-gray-700 rounded-2xl bg-gray-50 dark:bg-gray-900 p-6 shadow-sm">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
                            ...
                            <button type="button" onclick="addIngredient()" class="inline-flex items-center justify-center rounded-md bg-indigo-600 px-4 py-2 text-xs font-semibold text-white uppercase tracking-widest shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">+ Ajouter un ingrédient</button>
                        </div>
                                ...
                                @foreach($oldIngredients as $index => $ingredient)
                                    <div class="ingredient-row grid gap-3 sm:grid-cols-[1.4fr_1fr_1fr_auto] items-end p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
                                        ...
                                        <div class="flex items-center pt-6">
                                            <button type="button" onclick="removeIngredient(event)" class="inline-flex items-center justify-center rounded-md bg-red-600 px-3 py-2 text-xs font-semibold text-white shadow-sm hover:bg-red-500">Supprimer</button>
                                        </div>
                                    </div>
                                @endforeach
                            @else
                    ...
                    <div class="flex justify-end">
                        <button type="submit" class="inline-flex items-center justify-center rounded-md bg-green-600 px-6 py-3 text-xs font-semibold text-white uppercase tracking-widest shadow-sm hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Enregistrer le plat</button>
                    </div>
                </form>
            </div>
        </div>
